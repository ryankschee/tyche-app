...
@Repository  
public class PlaceAddressDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PlaceAddressBean.class.getSimpleName();
	}
  
	public PlaceAddressBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PlaceAddressBean> list = query.list();
			if (list.size() > 0)
				return list.get(0);  
			else
				return null;
	...
	public List<PlaceAddressBean> getBeansByPlaceId(String placeId) 
		throws DAOException
	{  
		try 
		{
