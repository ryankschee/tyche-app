...
@Repository  
public class PlaceLabelDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PlaceLabelBean.class.getSimpleName();
	}
  
	public PlaceLabelBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PlaceLabelBean> list = query.list();
	...
	public List<PlaceLabelBean> getBeansByPlaceId(String placeId) 
		throws DAOException
	{  
		try 
		{
