...
public class PlaceImageDAO 
	...
	{
		return PlaceImageBean.class.getSimpleName();
	}
  
	public PlaceImageBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PlaceImageBean> list = query.list();
	...
	public List<PlaceImageBean> getBeansByPlaceId(String placeId) 
		throws DAOException
	{  
		try 
		{
