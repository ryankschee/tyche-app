...
@Repository  
public class PlaceOperatingHourDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PlaceOperatingHourBean.class.getSimpleName();
	}
  
	public PlaceOperatingHourBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PlaceOperatingHourBean> list = query.list();
	...
	public List<PlaceOperatingHourBean> getBeansByPlaceId(String placeId) 
		throws DAOException
	{  
		try 
		{
