...
@Repository  
public class PlaceContactDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PlaceContactBean.class.getSimpleName();
	}
  
	public PlaceContactBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PlaceContactBean> list = query.list();
			if (list.size() > 0)
				return list.get(0);  
			else
				return null;
	...
	public List<PlaceContactBean> getBeansByPlaceId(String placeId) 
		throws DAOException
	{  
		try 
		{
