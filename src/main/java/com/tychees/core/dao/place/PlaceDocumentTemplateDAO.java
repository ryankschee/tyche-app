...
@Repository  
public class PlaceDocumentTemplateDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PlaceDocumentTemplateBean.class.getSimpleName();
	}
  
	public PlaceDocumentTemplateBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PlaceDocumentTemplateBean> list = query.list();
	...
	public List<PlaceDocumentTemplateBean> getBeansByPlaceId(String placeId) 
		throws DAOException
	{  
		try 
		{
