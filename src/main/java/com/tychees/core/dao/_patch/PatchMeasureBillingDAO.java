...
@Repository  
public class PatchMeasureBillingDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PatchMeasureBillingBean.class.getSimpleName();
	}
  
	public List<PatchMeasureBillingBean> getAll() 
		throws DAOException
	{  
		try 
		{		
	...
	public PatchMeasureBillingBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PatchMeasureBillingBean> list = query.list();
			if (list.size() > 0)
				return list.get(0);  
			else
				return null;
	...
	public List<PatchMeasureBillingBean> getBeansByMeasureId(String formId) 
		throws DAOException
	{  
		try 
		{		
