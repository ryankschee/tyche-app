...
@Repository  
public class PatchMeasureDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return PatchMeasureBean.class.getSimpleName();
	}
  
	public List<PatchMeasureBean> getAll() 
			throws DAOException
		{  
			try 
			{		
	...
	public PatchMeasureBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<PatchMeasureBean> list = query.list();
			if (list.size() > 0)
				return list.get(0);  
			else
				return null;
