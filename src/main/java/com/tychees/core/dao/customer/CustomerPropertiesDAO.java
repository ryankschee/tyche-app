...
@Repository  
public class CustomerPropertiesDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return CustomerPropertiesBean.class.getSimpleName();
	}
  
	public CustomerPropertiesBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<CustomerPropertiesBean> list = query.list();
			if (list.size() > 0)
				return list.get(0);  
			else
				return null;
	...
	public List<CustomerPropertiesBean> getBeansByCustomerId(String customerId) 
		throws DAOException
	{  
		try 
		{
