...
@Repository  
public class InventoryItemRuleDAO 
	extends AbstractDAO {  
  
	@Override
	public String getBeanName() 
	{
		return InventoryItemRuleBean.class.getSimpleName();
	}
  
	public InventoryItemRuleBean getBeanById(String id) 
		throws DAOException
	{  
		try 
		{
			...
			List<InventoryItemRuleBean> list = query.list();
			if (list.size() > 0)
				return list.get(0);  
			else
				return null;
	...
	public List<InventoryItemRuleBean> getBeansByItemId(String itemId) 
		throws DAOException
	{  
		try 
		{
