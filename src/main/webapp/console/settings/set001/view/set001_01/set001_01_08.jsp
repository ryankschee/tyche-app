...
<div id="set001_01_08" style="display:none; padding-top:10px;">
...
var set001_01_08_initialized = false;

/**
 * Init Panel
 */
function set001_01_08_init()
{
    if (set001_01_08_initialized == true)
        return false;
            
	set001_01_08_initialized = true;
} // .end of set001_01_08_init

/**
 * Show Panel
 */
function set001_01_08_updateUI()
{
    set001_01_08_init();
    ...
    $.each(settingsList, function(i, settingsObj){
    	...
    	if (lastGroupName != thisGroupName)
    	{
        	...
        	$('#set001_01_08_table').append(group_htmlLines);
    	}
    	...
    	$('#set001_01_08_table').append(htmlLines);
    ...
    $('#set001_01_08').show();
} // .end of set001_01_08_updateUI

/**
 * Hide Panel
 */
function set001_01_08_hide()
{
    $('#set001_01_08').hide();
} // .end of set001_01_08_hide
