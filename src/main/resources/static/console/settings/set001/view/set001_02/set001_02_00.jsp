...
<div id="set001_02_00" style="display:none;">
...
var set001_02_00_initialized = false;

/**
 * Init Panel
 */
function set001_02_00_init()
{
    if (set001_02_00_initialized == true)
        return false;
            
	set001_02_00_initialized = true;
} // .end of set001_02_00_init

/**
 * Show Panel
 */
function set001_02_00_updateUI()
{
    set001_02_00_init();
    ...
    $.each(settingsList, function(i, settingsObj){
    	...
    	if (lastGroupName != thisGroupName)
    	{
        	...
        	$('#set001_02_00_table').append(group_htmlLines);
    	}
    	...
    	$('#set001_02_00_table').append(htmlLines);
    ...
    $('#set001_02_00').show();
} // .end of set001_02_00_updateUI

/**
 * Hide Panel
 */
function set001_02_00_hide()
{
    $('#set001_02_00').hide();
} // .end of set001_02_00_hide
