			    ...
			    <div class="row">
	                        ...
	                        <div class="ibox-content">
	                            <form method="get" class="form-horizontal">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-8">
	                                    	<input type="text" class="form-control" id="set001_document_mw_editShape_componentName">
	                                    	<span id="set001_document_mw_editShape_componentName_error" class="help-block m-b-none" style="display:none; color:#FF0000;">Error: Invalid Value</span>
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                            	...
	                            	<div id="set001_document_mw_editShape_componentAttributes_left_top">
	                            	</div>
	                            	<div class="hr-line-dashed"></div>
	                            	<div id="set001_document_mw_editShape_componentAttributes_left_bottom">
	                            	</div>
	                            </form>
	                        </div>
	                    </div>
	                ...
	                <div class="col-md-5">
	                    <div class="ibox float-e-margins">
	                        <div class="ibox-content">
	                            <form method="get" class="form-horizontal">
	                                <div id="set001_document_mw_editShape_componentAttributes_right">
	                            	</div>
	                            </form>
	                        </div>
	                    </div>
...
function set001_document_mw_editShape_init()
{
    ...
    $('#set001_document_mw_editShape').on('shown.bs.modal', function () {
        // Set focus
        $('#set001_document_mw_editShape_componentName').focus();
	});
...
function set001_document_mw_editShape_updateUI()
{
    ...
    if (set001_document_mw_editShape_componentObj.objectType == DocumentConstants.COMPONENT_OBJECT_TYPE_TEXT) {
		...
		htmlLines_text += '<textarea rows="4" cols="50" class="form-control" id="set001_document_mw_editShape_text" style="height:100%;">' + attributesObj.text + '</textarea>';
		...
		htmlLines_requireUserInput += '<label>';
		htmlLines_requireUserInput += '<input type="checkbox" id="set001_document_mw_editShape_requireUserInput">'; 
		htmlLines_requireUserInput += '</label>';
		...
		htmlLines_afterComponent += '<select id="set001_document_mw_editShape_afterComponent" class="form-control">';
		htmlLines_afterComponent += '<option value="absolute">-- ABSOLUTE POSITION --</option>';
		
		$.each(set001_document_mw_editShape_templateObj.componentList, function(i, componentObj) {
	    	if (Cached_isDeletedBean(componentObj))
	    		return true;
	    	
	    	if (componentObj.id == set001_document_mw_editShape_componentObj.id)
	    		return true;
	    	
	    	var otherAttributesObj = JSON.parse(componentObj.attributes);
	    	if (otherAttributesObj.afterComponent == set001_document_mw_editShape_componentObj.id) {
	    		return true;
			}
		...
		$('#set001_document_mw_editShape_componentAttributes_left_top').empty();
		$('#set001_document_mw_editShape_componentAttributes_left_top').append(htmlLines_requireUserInput);
		$('#set001_document_mw_editShape_componentAttributes_left_top').append(htmlLines_afterComponent);
		$('#set001_document_mw_editShape_componentAttributes_left_bottom').empty();
		$('#set001_document_mw_editShape_componentAttributes_left_bottom').append(htmlLines_text);
		
		$('#set001_document_mw_editShape_componentAttributes_right').empty();
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_x1);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_y1);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_width);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_padding);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_fill);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_fontFamily);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_fontSize);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_fontStyle);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_align);
		
	    if (attributesObj.requireUserInput)
	    	$('#set001_document_mw_editShape_requireUserInput').iCheck('check');
	    else
	    	$('#set001_document_mw_editShape_requireUserInput').iCheck('uncheck');	    
    }    	
    ...
    if (set001_document_mw_editShape_componentObj.objectType == DocumentConstants.COMPONENT_OBJECT_TYPE_LINE) {
		...
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_x1);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_y1);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_x2);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_y2);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_stroke);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_strokeWidth);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_lineCap);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_dashEnabled);
    }  
    ...
    if (set001_document_mw_editShape_componentObj.objectType == DocumentConstants.COMPONENT_OBJECT_TYPE_BOX) {
		...
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_y1);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_width);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_height);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_fillEnabled);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_fill);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_strokeEnabled);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_stroke);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_strokeWidth);
		$('#set001_document_mw_editShape_componentAttributes_right').append(htmlLines_cornerRadius);
    }  
...
function set001_document_mw_editShape_save()
{
    ...
    // Shape: TEXT
    if (set001_document_mw_editShape_componentObj.objectType == DocumentConstants.COMPONENT_OBJECT_TYPE_TEXT) {
    	var componentName = $.trim( $('#set001_document_mw_editShape_componentName').val() );
		...
		var requireUserInput = $('#set001_document_mw_editShape_requireUserInput').prop('checked');
	    var positionAfterComponent = $('#set001_document_mw_editShape_afterComponent').val();

		if (componentName == '') {
	    	$('#set001_document_mw_editShape_componentName').focus();
			$('#set001_document_mw_editShape_componentName_error').show();
			return false;
		}
		...
		if (attributesObj.afterComponent == '' || attributesObj.afterComponent == 'absolute') {
			set001_document_mw_editShape_componentObj.seqno = 0;
		} else {
			$.each(set001_document_mw_editShape_templateObj.componentList, function(i, componentObj) {
				if (componentObj.id == attributesObj.afterComponent) {
					set001_document_mw_editShape_componentObj.seqno = componentObj.seqno + 1;
				}
			});
		}
		
		set001_document_mw_editShape_componentObj.name = componentName;
